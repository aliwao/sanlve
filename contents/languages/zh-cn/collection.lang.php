...
$LANG['test'] = '测试';
$LANG['url_msg'] = ' (如：http://www.contents.cn/help/rumen/(*).html,页码使用<a href="javascript:insertText(\'urlpage_1\', \'(*)\')">(*)</a>做为通配符。';
$LANG['page_from'] = '页码从';
$LANG['from'] = '从';
$LANG['to'] = '到';
$LANG['finish'] = '结束';
...
$LANG['nextpage_rule_msg'] = '请填写下一页超链接中间的代码。如：<a href="http://www.contents.cn/page_1.html">下一页</a>，他的“下一页规则”为“下一页”。';
$LANG['add_item'] = '添加项目';
$LANG['rulename'] = '规则名';
