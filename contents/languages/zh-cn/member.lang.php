...
$LANG['no_contents_account'] = '您还没有注册成为会员？';
$LANG['immediately'] = '立即';
...
$LANG['financial_management'] = '买家店购买记录';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录SANLVE,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录SANLVE,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录SANLVE,轻松使用盛大所有服务。';
