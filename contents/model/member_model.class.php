...
if(!defined('CACHE_MODEL_PATH')) define('CACHE_MODEL_PATH',SL_PATH.'caches'.DIRECTORY_SEPARATOR.'caches_model'.DIRECTORY_SEPARATOR.'caches_data'.DIRECTORY_SEPARATOR);
