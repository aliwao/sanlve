...
class manage extends admin {
	...
	public function dir() {
		...
		$local = str_replace(array(PC_PATH, SL_PATH ,DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR), array('','',DIRECTORY_SEPARATOR), $filepath);
		//$show_header = true;
	...
	public function pulic_dirmode_del() {
		...
		$tmpdir = SL_PATH.$tmpdirs[0].'/';
		if($tmpdir!=$this->upload_path) {
			showmessage(L('illegal_operation'));
		}
		$file = SL_PATH.$dir.DIRECTORY_SEPARATOR.$filename;
