<?php
/**
 *  base.php SANLVE框架入口文件
 *
 * @copyright			(C) 2016-2017 SANLVE
 * @license				http://www.contents.cn/license/
 * @lastmodify			2010-6-7
 */
define('IN_SANLVE', true);

//SANLVE框架路径
define('PC_PATH', dirname(__FILE__).DIRECTORY_SEPARATOR);

if(!defined('SL_PATH')) define('SL_PATH', PC_PATH.'..'.DIRECTORY_SEPARATOR);

//缓存文件夹地址
define('CACHE_PATH', SL_PATH.'caches'.DIRECTORY_SEPARATOR);
//主机协议
