...
final class db_mysqli {
	 ...
	 * 						为字符串时[例：`name`='contents',`hits`=`hits`+1]。
	 *						为数组时[例: array('name'=>'contents','password'=>'123456')]
	...
	public function halt($message = '', $sql = '') {
		if($this->config['debug']) {
			$this->errormsg = "<b>MySQL Query : </b> $sql <br /><b> MySQL Error : </b>".$this->error()." <br /> <b>MySQL Errno : </b>".$this->errno()." <br /><b> Message : </b> $message <br /><a href='http://faq.contents.cn/?errno=".$this->errno()."&msg=".urlencode($this->error())."' target='_blank' style='color:red'>Need Help?</a>";
			$msg = $this->errormsg;
