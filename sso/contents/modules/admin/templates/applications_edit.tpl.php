...
<table width="100%"  class="table_form">
  ...
  <tr>
   ...
   <tr>
	...
	<option value="contents_v9"<?php if ($data['type']=='contents_v9'){echo ' selected';}?>>contents_v9</option>
    <option value="contents_2008_sp4"<?php if ($data['type']=='contents_2008_sp4'){echo ' selected';}?>>contents_2008_sp4</option>
...
function change_apifile(value) {
	if (value=='contents'  && $('#apifilename').val() == '') {
