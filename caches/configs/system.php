...
'cookie_pre' => 'oDUrm_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
//附件相关配置
'upload_path' => SL_PATH.'uploadfile/',
'upload_url' => './uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://localhost:8090/sl/statics/js/', //CDN JS
'css_path' => 'http://localhost:8090/sl/statics/css/', //CDN CSS
'img_path' => 'http://localhost:8090/sl/statics/images/', //CDN img
'app_path' => 'http://localhost:8090/sl/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'qdxARdDb0gPR4smQMkwY', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost:8090/sl/sso',	//接口地址
'phpsso_auth_key' => 'PpwtTG5ZOGGFV6rdrGYkResNgXZKVwaw', //加密密钥
